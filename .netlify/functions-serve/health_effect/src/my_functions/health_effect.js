...
var init_referrer = __esm({
  "node_modules/node-fetch/src/utils/referrer.js"() {
    import_node_net = __toModule(require("net"));
...
var init_request = __esm({
  "node_modules/node-fetch/src/request.js"() {
    ...
    import_node_util3 = __toModule(require("util"));
    init_headers();
    init_body();
    init_is();
    init_get_search();
...
var API_ENDPOINT = "https://cat-fact.herokuapp.com/facts";
exports.handler = async (event, context) => {
  let response;
  try {
    response = await fetch2(API_ENDPOINT);
  } catch (err) {
    return {
